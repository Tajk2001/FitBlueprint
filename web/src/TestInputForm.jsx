...
function TestInputForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      ...
      >
        <h2 className="text-2xl font-semibold text-center">Enter your test results</h2>
        ...
        <button
          type="submit"
          className="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl mt-4 transition"
          disabled={loading}
        >
